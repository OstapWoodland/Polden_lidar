...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* tim_icHandle)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA10     ------> TIM1_CH3
    */
    HAL_GPIO_DeInit(GPIOA, ULTRASONIC_4_ECHO_Pin|ULTRASONIC_6_ECHO_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(ULTRASONIC_3_ECHO_GPIO_Port, ULTRASONIC_3_ECHO_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB8     ------> TIM4_CH3
    */
    HAL_GPIO_DeInit(GPIOB, ULTRASONIC_5_ECHO_Pin|ULTRASONIC_7_ECHO_Pin);
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PA2     ------> TIM5_CH3
    */
    HAL_GPIO_DeInit(GPIOA, ULTRASONIC_8_ECHO_Pin|ULTRASONIC_2_ECHO_Pin);
